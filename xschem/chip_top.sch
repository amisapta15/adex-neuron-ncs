...
N -690 -780 -690 -700 {lab=VGND}
N -690 -640 -690 -580 {lab=VDPWR}
...
m=5
spiceprefix=X}
C {lab_wire.sym} -690 -760 0 0 {name=Cadecap2[4:0] sig_type=std_logic lab=VGND}
C {lab_wire.sym} -690 -600 2 1 {name=Cadecap3[4:0] sig_type=std_logic lab=VDPWR}
